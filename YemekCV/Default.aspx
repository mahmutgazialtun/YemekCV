<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="YemekCV.Default" %>
...
<body>
            ...
            <div class="nav-top">
                <nav class="mnu mx-auto">
                    ...
                    <ul class="menu">
                        ...
                        <li class="mt-sm-3"><a href="#about" class="scroll">Ben Kimim?</a></li>
    ...
    <div class="main">
        ...
        <section class="slide-wrapper" id="about">
            <h2 class="w3_head mb-4">Ben Kimim?</h2>
